...
# Only the inner JSON string is needed (between the outer quotes).
RAW_PAYLOAD = r"""{"roomId":"eSMqw","instrument_token":"23737742814_full,27494082360_full,44695_full,70526413128_full,41830568678_full,20446366594_full,44439_full,20848323089_full,78072679092_full,71069778201_full,71406830696_full,97967302236_full,77383798437_full,50617248258_full,74641093214_full,74166801835_full,44693_full,43680_full,99823636843_full,47436858279_full,43681_full,45636526072_full,30356490010_full,80517313346_full","marketType":"badla","uniqId":"batch_badla","equation":{"6a0ae4d66121bd19cead3923":{"equation":"L1*L3","duty":[{"Duty":15}],"instrumentTokens":["23737742814_full","27494082360_full","44695_full"],"settingName":"CRUDE(COMEXJUNE-MCXJUNE)@JUNEDG","diffrenceValue":0,"reverse":"0"},"6a0b10036121bd19cead3925":{"equation":"Math.round(((((L1 + 2) * L3)/3.1104) + ((((L1 + 2) * L3)/3.1104)*D1/100)) * 0.995)","duty":[{"Duty":15}],"instrumentTokens":["70526413128_full","41830568678_full","44695_full"],"settingName":"GOLD-15%(COMEXJUNE-MCXJUNE)JUNEDG@PREMIUM@2","diffrenceValue":0,"reverse":"0"},"6a0c2ca76121bd19cead3926":{"equation":"L1","duty":[{"Duty":15}],"instrumentTokens":["70526413128_full","20446366594_full","44439_full"],"settingName":"GOLDMCX(JUNE)-SILVERMCX(JULY)","diffrenceValue":0,"reverse":"0"},"6a0e95a26121bd19cead3927":{"equation":"Math.round(((((L1 + 2) * L3)/3.1104) + ((((L1 + 2) * L3)/3.1104)*D1/100)) * 0.995)","duty":[{"Duty":15}],"instrumentTokens":["20848323089_full","78072679092_full","44695_full"],"settingName":"GOLD-15%(COMEXAUG-MCXAUG)@JUNEDG","diffrenceValue":0,"reverse":"0"},"6a0e960f6121bd19cead3928":{"equation":"Math.round(((((L1 + 2) * L3)/3.1104) + ((((L1 + 2) * L3)/3.1104)*D1/100)) * 0.995)","duty":[{"Duty":15}],"instrumentTokens":["20848323089_full","78072679092_full","44695_full"],"settingName":"GOLD-15%(COMEXAUG-MCXAUG)JUNEDG@PREMIUM@2","diffrenceValue":0,"reverse":"0"},"6a0e986c6121bd19cead392a":{"equation":"Math.round((((L1*100+6)*L3)/3.1104) + ((((L1*100+6)*L3)/3.1104) * D1 /100))","duty":[{"Duty":15}],"instrumentTokens":["20446366594_full","71069778201_full","44695_full"],"settingName":"SILVER15%-(COMEXJULY-MCXJULY)@JUNEDG","diffrenceValue":0,"reverse":"0"},"6a1002dd6121bd19cead392b":{"equation":"L1*L3","duty":[{"Duty":15}],"instrumentTokens":["71406830696_full","97967302236_full","44695_full"],"settingName":"NGAS(COMEXJUNE-MCXJUNE)JUNEDG","diffrenceValue":0,"reverse":"0"},"6a10033c6121bd19cead392c":{"equation":"Math.round(((((L1*2.204623)*L3))*D1)/100) + (((L1*2.204623)*L3))","duty":[{"Duty":4}],"instrumentTokens":["77383798437_full","50617248258_full","44695_full"],"settingName":"COPPER4%(COMEXJULY-MCXJUNE)@JUNEDG","diffrenceValue":0,"reverse":"0"},"6a10039d6121bd19cead392d":{"equation":"Math.round((L1*2.204623)*L3)","duty":[{"Duty":15}],"instrumentTokens":["77383798437_full","50617248258_full","44695_full"],"settingName":"COPPER(COMEXJULY-MCXJUNE)@JUNEDG (2.204623)","diffrenceValue":0,"reverse":"0"},"6a1577da6121bd19cead392e":{"equation":"Math.round((((L1*100+15)*L3)/3.1104) + ((((L1*100+15)*L3)/3.1104) * D1 /100))","duty":[{"Duty":15}],"instrumentTokens":["20446366594_full","71069778201_full","44695_full"],"settingName":"SILVER-15%(COMEXJULY-MCXJULY)@JUNEDG@PREMIUM@15","diffrenceValue":0,"reverse":"0"},"6a157a466121bd19cead392f":{"equation":"L1*2","duty":[{"Duty":15}],"instrumentTokens":["74641093214_full","74166801835_full","44695_full"],"settingName":"NIFTY-BANKNIFTY (JUNE)","diffrenceValue":0,"reverse":"0"},"6a157aae6121bd19cead3930":{"equation":"L1","duty":[{"Duty":15}],"instrumentTokens":["74166801835_full","44693_full","44695_full"],"settingName":"NIFTY-SGX(JUNE)","diffrenceValue":0,"reverse":"0"},"6a159db66121bd19cead3931":{"equation":"L1","duty":[{"Duty":15}],"instrumentTokens":["43680_full","78072679092_full","44695_full"],"settingName":"GOLD -SPOTGOLD(DEC) COMEXGOLD(AUG)","diffrenceValue":0,"reverse":"0"},"6a16cb836121bd19cead3932":{"equation":"Math.round(((((L1 + 2) * L3)/3.1104) + ((((L1 + 2) * L3)/3.1104)*D1/100)) * 0.995)","duty":[{"Duty":15}],"instrumentTokens":["20848323089_full","78072679092_full","44695_full"],"settingName":"GOLD-15%REV(JUNEDG)","diffrenceValue":0,"reverse":"1"},"6a16cccb6121bd19cead3933":{"equation":"Math.round((((L1*100+6)*L3)/3.1104) + ((((L1*100+6)*L3)/3.1104) * D1 /100))","duty":[{"Duty":15}],"instrumentTokens":["20446366594_full","71069778201_full","44695_full"],"settingName":"SILVER15%REV@JUNEDG","diffrenceValue":0,"reverse":"0"},"6a16cdaf6121bd19cead3934":{"equation":"L1","duty":[{"Duty":15}],"instrumentTokens":["20848323089_full","99823636843_full","44695_full"],"settingName":"GOLD-MINIGOLD(JULY) MCXGOLD(AUG)","diffrenceValue":0,"reverse":"0"},"6a16ee9b6121bd19cead3935":{"equation":"Math.round(((L1*32.15)*L3) + D1)","duty":[{"Duty":5000}],"instrumentTokens":["20446366594_full","71069778201_full","44695_full"],"settingName":"SILVER@5000@REV@JUNEDG","diffrenceValue":0,"reverse":"1"},"6a16eedf6121bd19cead3936":{"equation":"Math.round(((L1*32.15)*L3) + D1)","duty":[{"Duty":15}],"instrumentTokens":["20848323089_full","78072679092_full","44695_full"],"settingName":"GOLD@400000@REV@JUNEDG","diffrenceValue":0,"reverse":"1"},"6a1983726121bd19cead3937":{"equation":"Math.round(((L1 * L3) / 3.1104) * 0.995)","duty":[{"Duty":15}],"instrumentTokens":["20848323089_full","78072679092_full","44695_full"],"settingName":"GOLD-(COMEXAUG-MCXAUG)@JUNEDG","diffrenceValue":0,"reverse":"0"},"69fc426dbab8e09015512d39":{"equation":"L1","duty":[{"Duty":15}],"instrumentTokens":["70526413128_full","47436858279_full","44439_full"],"settingName":"GOLD-MINIGOLD(JUNE) MCXGOLD(JUNE)","diffrenceValue":0,"reverse":"0"},"6a040e47bab8e09015512d3c":{"equation":"Math.round(((((L1 + 2) * L3)/3.1104) + ((((L1 + 2) * L3)/3.1104)*D1/100)) * 0.995)","duty":[{"Duty":15}],"instrumentTokens":["70526413128_full","41830568678_full","44439_full","44695_full"],"settingName":"GOLD-15%(COMEXJUNE-MCXJUNE)@MAYDG","diffrenceValue":0,"reverse":"0"},"6a040eaebab8e09015512d3d":{"equation":"Math.round((((L1*100+6)*L3)/3.1104) + ((((L1*100+6)*L3)/3.1104) * D1 /100))","duty":[{"Duty":15}],"instrumentTokens":["20446366594_full","71069778201_full","44439_full","44695_full"],"settingName":"SILVER15%-(COMEXJULY-MCXJULY)@MAYDG","diffrenceValue":0,"reverse":"0"},"6a046907bab8e09015512d3f":{"equation":"Math.round((((L1*100+15)*L3)/3.1104) + ((((L1*100+15)*L3)/3.1104) * D1 /100))","duty":[{"Duty":15}],"instrumentTokens":["20446366594_full","71069778201_full","44439_full","44695_full"],"settingName":"SILVER-15%(COMEXJULY-MCXJULY)@MAYDG@PREMIUM@15","diffrenceValue":0,"reverse":"0"},"6a056828bab8e09015512d40":{"equation":"Math.round(((((L1 + 2) * L3)/3.1104) + ((((L1 + 2) * L3)/3.1104)*D1/100)) * 0.995)","duty":[{"Duty":15}],"instrumentTokens":["70526413128_full","41830568678_full","44695_full"],"settingName":"GOLD-15%(COMEXJUNE-MCXJUNE)@jUNEDG","diffrenceValue":0,"reverse":"0"},"699e91656754c439a4ad8e78":{"equation":"L1","duty":[{"Duty":15}],"instrumentTokens":["43681_full","71069778201_full","44695_full"],"settingName":"SILVER -SPOTSILVER(DEC) COMEXSILVER(JULY)","diffrenceValue":0,"reverse":"0"},"69cb71586754c439a4ad8e89":{"equation":"L1/2","duty":[{"Duty":15}],"instrumentTokens":["45636526072_full","30356490010_full","44695_full"],"settingName":"DOW-NASDAQ-SNP","diffrenceValue":0,"reverse":"0"},"697c47bdd64a70878cc02b0d":{"equation":"L1","duty":[{"Duty":15}],"instrumentTokens":["20446366594_full","80517313346_full","44439_full"],"settingName":"SILVER -MINISILVER(JULY) MCXSILVER(JUNE)","diffrenceValue":0,"reverse":"0"}},"response_type":"full","duty":[]}"""
